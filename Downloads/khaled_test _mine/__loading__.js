pc.script.createLoadingScreen(function (app) {
    // ====================================
    // Khaled.dev - PlayCanvas Splash Disabled
    // Custom loader in index.html
    // ====================================

    var showSplash = function () {
        // Splash screen disabled - using custom Khaled.dev loader
        console.log('PlayCanvas splash disabled - Custom loader active');
    };
    ...
    var setProgress = function (value) {
        // Optional: Log loading progress to console
        if (value === 0 || value === 1) {
    ...
    var createCss = function () {
        // CSS disabled - using custom styles from index.html
    };

    // Don't create CSS or show splash
    // createCss();  // Disabled
    // showSplash(); // Disabled
...
window.SCENE_PATH = "2355290.json";
